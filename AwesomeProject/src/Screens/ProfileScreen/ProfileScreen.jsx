...
export const ProfileScreen = () => {
    ...
    const pickImage = async () => {
        ...
        if (!result.canceled) {
            dispatch(updUserAvatar({ photo: result.assets[0].uri, folder: 'avatars' }));
        }
            ...
            <BackgroundImage>
                <View style={styles.container}>
                    ...
                    <View style={styles.userPhotoContainer}>
                        <Image style={{ borderRadius: 16, width: 120, height: 120 }} source={{ uri: userPhoto }} />
                        {photoLink ? (
                            <TouchableOpacity style={globalStyles.deletePhotoBtn} onPress={() => dispatch(delUserAvatar())}>
                                <CrossIcon />
                            </TouchableOpacity>
                        ) : (
