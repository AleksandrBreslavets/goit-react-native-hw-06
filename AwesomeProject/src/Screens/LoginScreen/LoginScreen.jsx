                        ...
                        <View style={{ flex: 1, justifyContent: "flex-end" }}>
                            <View style={[
                                ...
                                <TouchableOpacity onPress={handleFormSubmit} style={[globalStyles.button,globalStyles.activeBtn]}>
                                    <Text style={[globalStyles.commonTextStyles, globalStyles.activeBtnValue]}>Увійти</Text>
                                </TouchableOpacity>
                                <View style={styles.signInBox}>
                                    <Text style={[globalStyles.commonTextStyles, styles.signInText]}>Немає акаунту?{" "}</Text>
                                    <TouchableOpacity onPress={()=>navigation.navigate("Registration")}>
                                        <Text style={[globalStyles.commonTextStyles, styles.signInText, styles.signInLink]}>Зареєструватися</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
